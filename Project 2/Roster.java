...
public class Roster {
    ...
    /**
     * This method prints the Student array list as is.
     *
     ...
     * Student Name. Once the array list is sorted, the method then prints
     * out the contents of each Student in order by using the toString()
     * method.
     */
     ...
     * method then prints out the contents of each Student who has paid in
     * order by using the toString() method.
     */
