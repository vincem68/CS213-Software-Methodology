package tuition;
/**
 * This class represents an International Student within the roster.
 *
 * Each International Student is considered to be a NonResident Student.
 *
 * Each International Student contains the same instance variables as both
 * the NonResident class and the Student class. This is because the
 * International class inherits from the NonResident class which
 * itself inherits from the Student class.
 *
 * Each International Student has a profile that contains their name and
 * major, an integer representative of the number of credits they are taking,
 * and a status that states whether they are studying abroad.
 *
