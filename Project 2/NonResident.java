package tuition;
/**
 * This class represents a NonResident Student within the roster.
 *
 * Each NonResident Student can also be considered as just a Student as well.
 *
 * Each NonResident Student contains the same instance variables as the
 * Student class. This is because the NonResident class inherits from the
 * Student class. The Student class is a superclass of the NonResident class.
 *
 * Each NonResident Student has a profile that contains their name and major
 * as well as an integer that represents the number of credits they are
 * taking.
 *
